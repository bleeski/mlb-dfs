...
1. Macro: `rm -rf /home/claude/work && mkdir -p /home/claude/work && cp -r /mnt/project/* /home/claude/work/ && cd /home/claude/work && python project_audit.py --run-tests --terse` -> `PASS v2.26.0 24 files 119 tests`. If the audit fails on pins or inventory only while `python -m unittest test_core` passes in full, proceed and flag; never repair infrastructure mid-slate.
