...
EXPECTED_TEST_COUNT = 338  # core 263 + showdown 30 + upload_integrity 44 + golden 1

EXPECTED_VERSION_TEXT = {
    "MLB_Classic.md": "v2.26.0",
    "mlb_engine/optimize/optimizer_v3.py": "OPTIMIZER_VERSION = 'v3.22'",
    ...
    "mlb_engine/pipeline/execution_pipeline.py": 'VERSION = "v1.13"',
